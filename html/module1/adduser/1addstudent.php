   ...
   <div class="container">
      <form action="" method="post">
         ...
         <table class="au">
            <tr>
               <th>Student ID</th>
               <td><input type="text" name="stdid" class="form-control"><br></td>
            </tr>

            <tr>
               <th>Name</th>
               <td> <input type="text" name="stdname" class="form-control"><br></td>
            </tr>

            <tr>
               <th>Password</th>
               <td> <input type="text" name="stdpassword" class="form-control"><br></td>
            </tr>

            <tr>
               <th>Address</th>
               <td> <input type="text" name="stdaddress" class="form-control"><br></td>
            </tr>

            <tr>
               <th>Email</th>
               <td> <input type="email" name="stdemail" class="form-control"><br></td>
            </tr>
            <tr>

               <th>Phone Number</th>
               <td> <input type="text" name="stdhpnum" class="form-control"><br></td>
            </tr>
            ...
            <tr>
               ...
               <td> <input type="text" name="stdevcomp" class="form-control"><br></td>
            </tr>
