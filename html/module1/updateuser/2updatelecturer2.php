                            ...
                            <form class="needs-validation" action="" method="post" novalidate>
                                ...
                                <div class="form-group  mb-3">
                                    ...
                                    <select name="lectposition" id="lectposition" class="form-select form-select-sm mb-3">
                                        <option value="Professor" <?php if ($row['lect_position'] == 'Professor') {
                                                                        echo 'selected="selected"';
                                                                    } ?>>Professor</option>
                                        <option value="Associate Professor" <?php if ($row['lect_position'] == ' Assoiciate Professor') {
                                                                                echo 'selected="selected"';
                                                                            } ?>>Associate Professor</option>
                                        <option value="Senior Lecturer" <?php if ($row['lect_position'] == 'Senior Lecturer') {
                                                                            echo 'selected="selected"';
                                                                        } ?>>Senior Lecturer</option>
                                        <option value="Lecturer" <?php if ($row['lect_position'] == 'Lecturer') {
                                                                        echo 'selected="selected"';
                                                                    } ?>>Lecturer</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group  mb-3">
                                    ...
                                    <select name="lectfaculty" id="lectfaculty" class="form-select form-select-sm mb-3">
                                        <option value="FK" <?php if ($row['lect_faculty'] == 'FK') {
                                                                echo 'selected="selected"';
                                                            } ?>>FK</option>
                                        <option value="FTEK" <?php if ($row['lect_faculty'] == 'FTEK') {
                                                                    echo 'selected="selected"';
                                                                } ?>>FTEK</option>
                                        <option value="FTKKP" <?php if ($row['lect_faculty'] == 'FTKKP') {
                                                                    echo 'selected="selected"';
                                                                } ?>>FTKKP</option>
                                        <option value="FIM" <?php if ($row['lect_faculty'] == 'FIM') {
                                                                echo 'selected="selected"';
                                                            } ?>>FIM</option>
                                        <option value="FTKA" <?php if ($row['lect_faculty'] == 'FTKA') {
                                                                    echo 'selected="selected"';
                                                                } ?>>FTKA</option>
                                        <option value="FTKEE" <?php if ($row['lect_faculty'] == 'FTKEE') {
                                                                    echo 'selected="selected"';
                                                                } ?>>FTKEE</option>
                                    </select>
                                </div>
