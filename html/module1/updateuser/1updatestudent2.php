                ...
                <div class="sb-sidenav-menu">
                    <div class="nav mt-3">
                        ...
                        <div class="collapse  show" id="collapseEditUser" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav nav-pills nav-fill">
                                <a class="nav-link  text-light active" href="http://localhost/StudFYP_Project/html/module_1/updateuser/1updatestudent.php">
                                    <div class="sb-nav-link-icon">
...
{  
     ...
     if (mysqli_query($db, $update)) {
      ...
      echo '</script>';
      echo "<script>window.open('http://localhost/StudFYP_Project/html/module_1/updateuser/1updatestudent.php','_self')</script>";
     } else {
