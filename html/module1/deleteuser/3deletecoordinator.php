            ...
            <main>
                <div class="container-fluid px-4">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Delete All Coordinator's Data</h5>
                    ...
                    if (isset($_POST['Confirm'])) {
                        $deleteall = "DELETE FROM fyp_coordinator ";
                        if ($db->query($deleteall) === TRUE) {
                    ...
                    if (isset($_POST['Search'])) {
                        if (empty($_POST['getcorid'])) {
                            ...
                            $delete = "SELECT * FROM fyp_coordinator where lect_id = '$getcorid' ";
                            $result = $db->query($delete);
                            echo "<table class= table table-hover table-bordered >";
                            if ($result->num_rows > 0) {
                                $_SESSION['getcorid'] = $getcorid;
                                echo "<script>window.open('3deletecoordinator2.php','_self')</script>";
                            } else {
