            ...
            <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav mt-3">
                        ...
                        <div class="collapse show" id="collapseDeleteUser" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav nav-pills nav-fill">
                                ...
                                <a class="nav-link text-light active" href=3deletecoordinator.php">
                                    <div class="sb-nav-link-icon ">
            ...
            <main>
                ...
                if (isset($_POST['Delete'])) {
                    ...
                    if ($db->query($sql) === TRUE) {
                        ...
                        echo '</script>';
                        echo "<script>window.open('3deletecoordinator.php','_self')</script>";
                    } else {
