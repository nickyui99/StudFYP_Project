                    ...
                    <div class="nav mt-3">
                        ...
                        <div class="collapse show" id="collapseDeleteUser" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav nav-pills nav-fill">
                                ...
                                <a class="nav-link text-light active" href="4deleteindustrialpanel.php">
                                    <div class="sb-nav-link-icon">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    if (isset($_POST['Confirm'])) {
                        $deleteall = "DELETE FROM industrial_panel ";
                    ...
                    if (isset($_POST['Search'])) {
                        if (empty($_POST['getipid'])) {
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<script>window.open('4deleteindustrialpanel2.php','_self')</script>";
                            } else {
                                echo '<script type="text/javascript">';
